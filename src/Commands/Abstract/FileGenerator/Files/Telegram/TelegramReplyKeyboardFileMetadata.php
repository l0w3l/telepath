...
final readonly class TelegramReplyKeyboardFileMetadata implements FileMetadataInterface
{
    ...
    {
        if (Str::endsWith($argumentName, 'ReplyKeyboardFactory')) {
            return $argumentName;
        } else {
            return "{$argumentName}ReplyKeyboardFactory";
        }
    }
}
